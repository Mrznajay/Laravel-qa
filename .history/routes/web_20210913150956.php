...
Route::post('/answers/{answer}/accept', App\Http\Controllers\AcceptAnswerController::class)->name('question.favorites');

Route::post('/questions/{question}/favorites', App\Http\Controllers\AcceptAnswerController::class,'store')->name('answers.accept');
