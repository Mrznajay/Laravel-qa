...
Route::post('/questions/{question}/favorites', [App\Http\Controllers\FavoriteController::class,'store'])->name('question.favorite');

Route::delete('/questions/{question}/favorites', [App\Http\Controllers\FavoriteController::class,'destroy'])->name('question.unfavorite');
