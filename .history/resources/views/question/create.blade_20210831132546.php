                ...
                <div class="card-body">
                    <form action="{{ route('question.store') }}" method="post">
                        ...
                        <div class="from-group">
                            ...
                            <input type="text" name="title" id="question-title" class="form-control" {{ $error->has('title') ? }}>
                        ...
                        <div class="from-group">
                            ...
                            <textarea rows="10" name="body" id="question-body" class="form-control" {{ $error->has('title') ? }}> </textarea>
