                ...
                <div class="media">
                    <div class="d-flex flex-column vote-controls">
                        ...
                        <a title="Click to mark as favorite question (Click again to undo)" 
                            class="favorite mt-2 {{ Auth::guard() ? 'off' : ($question->is_favorite ? 'favorited' : '') }}"
                            onclick="event.preventDefault(); document.getElementById('favorite-question-{{ $answer->id }}').submit();">
