               ...
               <div class="card-body">
                ...
                <div class="media">
                    <div class="d-flex flex-column vote-controls">
                        ...
                        <a title="Click to mark as favorite question (Click again to undo)" class="favorite favorite mt-2 favorited">
                    ...
                    @foreach ($question->answers as $answer)
                        ...
                        <div class="media">
                            <div class="d-flex flex-column vote-controls">
                                ...
                                <a title="Mark this answer as best answer" class="vote-accepted mt-2" class="favorite vote-accepted mt-2 favorited">
