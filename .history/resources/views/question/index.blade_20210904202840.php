        ...
        <div class="col-md-8">
            <div class="card">
                ...
                @if (Session::has('success'))
                    <div class="alert alert-success alert-dismissable" {{ Session::has('success') ? 'session_imp' : '' }}>
                        @if (Session::has('success_imp'))
                        ...
                        <div class="media">
                            <div class="d-flex flex-column counters">
                                ...
                                <div class="status {{ $q->status }}">
                                    ...
                                    {{ Str::plural('answers_count', $q->answers_count) }}
                                </div>
                                <div class="view">
...
<script>
        $('div.alert').not('.success_imp').delay(3000).slideUp(300);
    </script>
@endsection
