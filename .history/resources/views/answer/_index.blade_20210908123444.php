                                ...
                                <div class="col-4">
                                    <div class="ml-auto">
                                        @can ('update',$questions)
                                            <a href="{{ route('questions.answer.edit',[$question]$answer->id) }}" class="btn btn-sm btn-outline-info">Edit</a>    
                                        @endcan
                                        
                                        @can ('delete',$answer)
                                            <form action="{{ route('answer.destroy',$answer->id) }}" method="post" class="form-delete">
                                                @method('DELETE')
                                                @csrf
