                                ...
                                <div class="col-4">
                                    <div class="ml-auto">
                                        @can ('update',$questions)
                                            <a href="{{ route('answers.edit',$answers->id) }}" class="btn btn-sm btn-outline-info">Edit</a>    
                                        @endcan
                                        
                                        @can ('delete',$answers)
                                            <form action="{{ route('answers.destroy',$answers->id) }}" method="post" class="form-delete">
                                                @method('DELETE')
                                                @csrf
